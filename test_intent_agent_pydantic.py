#!/usr/bin/env python
"""Test the enhanced PydanticAI intent agent."""
...
async def run_test():
    """Run the test on the enhanced intent agent."""
    
    print("Testing enhanced PydanticAI intent agent...\n")
    
    for query in TEST_QUERIES:
        print(f"\nQuery: {query}")
        
        # Process with enhanced agent
        result = await classify_intent_enhanced(query, SAMPLE_SCHEMA)
