"""Utility to set up a sample PostgreSQL database for testing."""
...
def create_sample_postgres_database():
    """Create a sample PostgreSQL database for testing."""
    # Make sure we're using PostgreSQL
    if settings.DB_TYPE != 'postgresql':
        logger.warning("This utility is only for PostgreSQL databases. Skipping sample database creation.")
        return
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            logger.info(f"Successfully connected to PostgreSQL database: {settings.DB_NAME}")
        ...
        logger.info("Created sample tables in PostgreSQL database")
        ...
        logger.info("Inserted sample data into PostgreSQL database")
        
    except Exception as e:
        logger.error(f"Error creating sample PostgreSQL database: {str(e)}")
        raise 