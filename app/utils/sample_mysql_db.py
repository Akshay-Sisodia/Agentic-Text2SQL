"""Utility to set up a sample MySQL database for testing."""
...
def create_sample_mysql_database():
    """Create a sample MySQL database for testing."""
    # Make sure we're using MySQL
    if settings.DB_TYPE != 'mysql':
        logger.warning("This utility is only for MySQL databases. Skipping sample database creation.")
        return
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            logger.info(f"Successfully connected to MySQL database: {settings.DB_NAME}")
        ...
        logger.info("Created sample tables in MySQL database")
        ...
        logger.info("Inserted sample data into MySQL database")
        
    except Exception as e:
        logger.error(f"Error creating sample MySQL database: {str(e)}")
        raise 